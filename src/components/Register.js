...
const Register = () => {
  ...
  const handleSubmit = (event) => {
    ...
    console.log(formData); // Example: Log the FormData to the console
    navigate("/signin");
  };
    ...
    <div className='register-grid'>
      ...
      <form onSubmit={handleSubmit} action="">
          ...
          <div className="registration-details">
            <div className="first-row">
              ...
              <div className="advocate-name">
                ...
                <input type="text" name="advocate-name" id="advocate" />
              </div>

              <div className="state-name">
                <p className="labels" id='state__p'>State</p>
                <select name="state" id="state" className='state__select'>
          ...
          <div className='opp'>
            <div className="first-row-opp">
              ...
              <div className="state-name-opp">
                <p className="labels" id='state__p'>State</p>
                <input type="text" name="state-name-opp" id="state" />
              </div>
            </div>
            <div className="second-row-opp">
              <div className="district-name">
                <p className="labels" id='district__p'>District</p>
                <select name="district" id="district" className='district__select'>
          ...
          <div className='cd'>
            <div className="first-row-cd">
              <div className="mobile-no-div" id="mobile-no-div">
                ...
                <input type="text" name="mobile-no" id="mobile-no" placeholder='Mobile Number' />
              </div>
        ...
        <div className="register-buttons">
          <button type="submit" className="submit__button-case-filing" style={{ "color": "white", "cursor": "pointer" }} >Submit</button>
        </div>
      </form>
    </div>
  )
